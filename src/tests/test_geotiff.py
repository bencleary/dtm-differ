...
def test_validate_dem_data_sufficient():
...
def test_validate_dem_data_insufficient():
...
def test_validate_dem_data_with_nodata():
...
def test_validate_dem_data_no_nodata():
